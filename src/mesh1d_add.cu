...
__host__ Error
Mesh1D::add(OperationSpace space, const double c) {
...
__host__ Error
Mesh1D::add(OperationSpace space, Mesh1D& x) {
...
__host__ Error
Mesh1D::add(OperationSpace space, const double c, Mesh1D& x) {
...
__host__ Error
Mesh1D::add(OperationSpace space, Mesh1D& c, Mesh1D& x) {
